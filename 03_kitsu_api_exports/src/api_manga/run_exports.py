...
from .exporter import _run_id_now, _write_latest_marker, export_most_popular, export_top_publishing, export_trending_weekly
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Runner: exports trending/publishing/popular to JSON.")
    parser.add_argument("--out-dir", default="exports", help="Output directory (default: exports).")
    parser.add_argument(
        "--run-id",
        help="Identifiant de run (défaut: horodaté). Les exports sont écrits dans out-dir/runs/<run-id>/",
    )
    ...
    parser.add_argument("--no-authors", action="store_true", help="Skip authors fetch (faster).")
