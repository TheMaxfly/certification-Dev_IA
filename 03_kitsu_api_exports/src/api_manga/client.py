...
class KitsuClient:
    ...
    def fetch_manga_by_slug(self, slug: str) -> Optional[Dict[str, Any]]:
    ...
    def fetch_manga_detail(self, manga_id: str, include: Optional[str] = None) -> Dict[str, Any]:
        params: Dict[str, Any] = {}
        if include:
    ...
    def fetch_staff(self, manga_id: str, include: str = "person", limit: int = 20) -> Dict[str, Any]:
        params = {"include": include, "page[limit]": min(limit, 20)}
        return self._request(f"manga/{manga_id}/staff", params=params)

    # (tu peux garder fetch_manga_staff si tu veux, mais fetch_staff est ton “happy path”)
    def fetch_manga_staff(self, manga_id: str, include: str = "person", limit: int = 20) -> Dict[str, Any]:
        params = {"include": include, "page[limit]": min(limit, 20)}
